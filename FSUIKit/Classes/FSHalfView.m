...
- (void)halfDesignViews{
    ...
    _tableView = [[UITableView alloc] initWithFrame:CGRectMake(self.bounds.size.width, 0, size.width - 60, size.height - _fs_statusAndNavigatorHeight()) style:UITableViewStylePlain];
