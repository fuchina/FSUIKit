...
@interface FSTuple : NSObject

@end

@interface Tuple2<objectType1,objectType2> : NSObject
...
@property (nonatomic,strong) id _5;
@property (nonatomic,strong) id _6;
@property (nonatomic,strong) id _7;
...
@property (nonatomic,strong) id _6;
@property (nonatomic,strong) id _7;
@property (nonatomic,strong) id _8;
...
@property (nonatomic,strong) id _7;
@property (nonatomic,strong) id _8;
@property (nonatomic,strong) id _9;
...
@property (nonatomic,strong) id _8;
@property (nonatomic,strong) id _9;
@property (nonatomic,strong) id _10;
